...
J.STYLES = {
  noir: {
    name: 'Noir Chroma', desc: 'black ground, white type, cyan/amber color offset',
    schemes: [
  ...
  crimson: {
    name: 'Crimson Signal', desc: 'deep crimson ground, two-tier white and black type, data corruption',
    schemes: [
  ...
  caution: {
    name: 'Caution', desc: 'yellow ground, red and blue accents, gauge UI',
    schemes: [
  ...
  magenta: {
    name: 'Pop Magenta', desc: 'shocking pink × white, bold rounded Gothic, leader lines',
    schemes: [
  ...
  paper: {
    name: 'Paper Ink', desc: 'paper texture, indigo and magenta, Mincho afterimages',
    schemes: [
  ...
  hud: {
    name: 'Dark HUD', desc: 'charcoal ground, hairline frames, orange accent, eclipse',
    schemes: [
  ...
  mint: {
    name: 'Mint Terminal', desc: 'black × teal × lime, stuck-on labels, slit-scan',
    schemes: [
  ...
  specimen: {
    name: 'Specimen', desc: 'ink-black ground, Mincho, dictionary annotations and leader lines',
    schemes: [
  ...
  transit: {
    name: 'Transit', desc: 'olive × yellow, arrows and signage, halftone dots',
    schemes: [
  ...
  blueprint: {
    name: 'Blueprint', desc: 'vivid blue × white × black, shape collage, diagonal bands',
    schemes: [
  ...
  rouge: {
    name: 'Rouge Gradient', desc: 'light gray ground, red gradients, capsules',
    schemes: [
  ...
  mono: {
    name: 'Mono RGB', desc: 'gray space, white Mincho, strong RGB split, coordinate circles',
    schemes: [
