/* JIZURA pack: exitB — 39 more exits + 12 more holds (idle motion)
...
X.peelOff = {
  name: 'Sticker Peel', tags: ['pop', 'graphic'], w: 1, ae: 'wipe',
...
X.crumpleOut = {
  name: 'Crumple & Toss', tags: ['pop', 'emotional'], w: 0.9, ae: 'shrink', minDur: 0.8,
...
X.tearOut = {
  name: 'Tear Away', tags: ['emotional', 'graphic'], w: 0.9, ae: 'slice',
...
X.scorchOut = {
  name: 'Scorch Away', tags: ['emotional', 'glitch'], w: 0.8, ae: 'wipe',
...
X.overexposeOut = {
  name: 'White Out', tags: ['emotional', 'calm', 'pop'], w: 1, ae: 'blur',
  apply(env, it, p) {
...
X.scanOut = {
  name: 'Scanline Erase', tags: ['glitch', 'graphic'], w: 0.9, ae: 'slice',
  apply(env, it, p) {
...
X.stripesOut = {
  name: 'Stripe Erase', tags: ['graphic', 'pop'], w: 0.9, ae: 'wipe',
  apply(env, it, p) {
...
X.halftoneOut = {
  name: 'Halftone Fade', tags: ['graphic', 'calm'], w: 0.9, ae: 'shrink',
  apply(env, it, p) {
...
X.eraserOut = {
  name: 'Chalkboard Eraser', tags: ['editorial', 'calm'], w: 0.9, ae: 'wipe', minDur: 0.9,
  outDur: dur => J.clamp(dur * 0.42, 0.36, 0.85),
  apply(env, it, p) {
...
X.vacuumOut = {
  name: 'Vacuum', tags: ['pop', 'graphic'], w: 0.9, ae: 'shrink',
  apply(env, it, p) {
...
X.sandOut = {
  name: 'Turn to Sand', tags: ['emotional', 'calm'], w: 1, ae: 'drift',
...
X.shredOut = {
  name: 'Shredder', tags: ['graphic', 'pop'], w: 0.8, ae: 'fall', minDur: 0.9,
...
X.dominoOut = {
  name: 'Dominoes', tags: ['pop', 'graphic'], w: 0.9, ae: 'fall', minDur: 0.8,
...
X.hingeOut = {
  name: 'Hinge Drop', tags: ['pop', 'editorial'], w: 0.9, ae: 'fall', minDur: 0.9,
...
X.rocketOff = {
  name: 'Liftoff', tags: ['pop'], w: 0.9, ae: 'drift', minDur: 0.8,
...
X.bounceOff = {
  name: 'Bounce Away', tags: ['pop'], w: 0.9, ae: 'scatter', minDur: 0.8,
...
X.balloonOff = {
  name: 'Balloon Away', tags: ['emotional', 'calm', 'pop'], w: 0.9, ae: 'drift', minDur: 0.9,
...
X.deflateOut = {
  name: 'Deflate', tags: ['pop'], w: 0.8, ae: 'scatter',
  outDur: dur => J.clamp(dur * 0.42, 0.36, 0.85),
  apply(env, it, p) {
...
X.hazeOut = {
  name: 'Haze Away', tags: ['emotional', 'calm'], w: 0.9, ae: 'blur',
  apply(env, it, p) {
...
X.glassBreak = {
  name: 'Glass Break', tags: ['graphic', 'pop', 'glitch'], w: 0.8, ae: 'explode',
  outDur: dur => J.clamp(dur * 0.42, 0.36, 0.85),
  apply(env, it, p) {
    const single = isSingle(env, it);
...
X.zipOut = {
  name: 'Zipper', tags: ['graphic', 'pop'], w: 0.8, ae: 'wipe',
  apply(env, it, p) {
...
X.clapShut = {
  name: 'Clap Shut', tags: ['graphic', 'pop'], w: 0.9, ae: 'wipe',
  apply(env, it, p) {
...
X.lampOff = {
  name: 'Lights Out', tags: ['glitch', 'emotional'], w: 0.8, ae: 'glitch',
  apply(env, it, p) {
...
X.slotOut = {
  name: 'Slot Reels', tags: ['glitch', 'pop'], w: 0.8, ae: 'glitch',
...
X.clockOut = {
  name: 'Clock Wipe', tags: ['graphic', 'editorial'], w: 0.9, ae: 'wipe',
  apply(env, it, p) {
...
X.matrixOut = {
  name: 'Digital Rain', tags: ['glitch'], w: 0.8, ae: 'glitch',
...
X.tornadoOut = {
  name: 'Tornado', tags: ['pop'], w: 0.8, ae: 'scatter', minDur: 0.8,
  outDur: dur => J.clamp(dur * 0.45, 0.38, 0.9),
  apply(env, it, p) {
...
X.rollUpOut = {
  name: 'Roll Up', tags: ['graphic', 'editorial'], w: 0.8, ae: 'wipe',
  outDur: dur => J.clamp(dur * 0.4, 0.32, 0.8),
  apply(env, it, p) {
...
X.snakeOut = {
  name: 'Snake Away', tags: ['calm', 'pop'], w: 0.9, ae: 'stretch', minDur: 0.8,
  outDur: dur => J.clamp(dur * 0.45, 0.38, 0.9),
  apply(env, it, p) {
...
X.flutterOut = {
  name: 'Flutter Down', tags: ['emotional', 'calm'], w: 1, ae: 'fall', minDur: 0.8,
  outDur: dur => J.clamp(dur * 0.48, 0.42, 1.0),
  apply(env, it, p) {
...
X.rollOff = {
  name: 'Roll Away', tags: ['pop'], w: 0.8, ae: 'scatter', minDur: 0.8,
  outDur: dur => J.clamp(dur * 0.45, 0.38, 0.9),
  apply(env, it, p) {
...
X.fanClose = {
  name: 'Fan Close', tags: ['graphic', 'editorial', 'emotional'], w: 0.9, ae: 'shrink', minDur: 0.8,
...
X.rgbSplitOut = {
  name: 'Color Split', tags: ['glitch', 'pop'], w: 0.9, ae: 'glitch',
  apply(env, it, p) {
...
X.shockOut = {
  name: 'Shockwave', tags: ['pop', 'graphic'], w: 0.9, ae: 'explode',
  apply(env, it, p) {
...
X.floodOut = {
  name: 'Flood', tags: ['emotional', 'calm'], w: 0.9, ae: 'wipe',
  outDur: dur => J.clamp(dur * 0.4, 0.32, 0.8),
  apply(env, it, p) {
...
X.slashOut = {
  name: 'Sword Slash', tags: ['graphic', 'emotional', 'pop'], w: 1, ae: 'slice',
  outDur: dur => J.clamp(dur * 0.4, 0.32, 0.8),
  apply(env, it, p) {
...
let MOS = null;
X.mosaicOut = {
  name: 'Mosaic', tags: ['glitch', 'graphic'], w: 0.9, ae: 'glitch',
  apply(env, it, p) {
...
X.scribbleOut = {
  name: 'Scribble Out', tags: ['editorial', 'emotional', 'pop'], w: 0.8, ae: 'wipe',
  outDur: dur => J.clamp(dur * 0.4, 0.32, 0.8),
  apply(env, it, p) {
...
X.candleOut = {
  name: 'Blow Out', tags: ['emotional', 'calm'], w: 0.9, ae: 'drift',
  outDur: dur => J.clamp(dur * 0.45, 0.38, 0.9),
  apply(env, it, p) {
...
H.glowFlicker = {
  name: 'Candle Flicker', tags: ['calm', 'emotional'], w: 0.5, ae: 'breathe',
  apply(env, it, amt) {
...
H.windGust = {
  name: 'Gust', tags: ['pop', 'emotional'], w: 0.5, ae: 'wave',
  apply(env, it, amt) {
    const k = amt * motionK(env); if (k < 0.01) return;
...
H.dangle = {
  name: 'Dangle', tags: ['calm', 'emotional'], w: 0.5, ae: 'wave',
  apply(env, it, amt) {
    const k = amt * motionK(env); if (k < 0.01) return;
...
H.eqBounce = {
  name: 'Equalizer', tags: ['pop', 'graphic'], w: 0.5, ae: 'breathe',
  apply(env, it, amt) {
    const k = amt * motionK(env); if (k < 0.01) return;
...
H.flashBox = {
  name: 'Beat Invert', tags: ['pop', 'graphic', 'glitch'], w: 0.4, ae: 'glitchtick',
  apply(env, it, amt) {
...
H.glintSweep = {
  name: 'Sheen', tags: ['graphic', 'calm'], w: 0.5, ae: 'still',
  apply(env, it, amt) {
...
H.flipSwap = {
  name: 'Occasional Flip', tags: ['glitch', 'pop'], w: 0.4, ae: 'glitchtick',
  apply(env, it, amt) {
...
H.shadowSway = {
  name: 'Swaying Shadow', tags: ['calm', 'emotional'], w: 0.5, ae: 'drift',
  apply(env, it, amt) {
...
H.magnetJiggle = {
  name: 'Magnetism', tags: ['pop', 'glitch'], w: 0.4, ae: 'jitter',
  apply(env, it, amt) {
    const k = amt * motionK(env); if (k < 0.01) return;
...
H.typeRattle = {
  name: 'Typewriter Rattle', tags: ['editorial', 'glitch'], w: 0.5, ae: 'jitter',
  apply(env, it, amt) {
    const k = amt * motionK(env); if (k < 0.01) return;
...
H.focusRack = {
  name: 'Rack Focus', tags: ['calm', 'emotional'], w: 0.5, ae: 'breathe',
  apply(env, it, amt) {
    const k = amt * motionK(env); if (k < 0.01) return;
...
H.pluckString = {
  name: 'Plucked String', tags: ['pop', 'emotional'], w: 0.4, ae: 'wave',
  apply(env, it, amt) {
    const k = amt * motionK(env); if (k < 0.01) return;
    let tau;
