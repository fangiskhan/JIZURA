/* ============================================================
   ...
   1) Extras (extra): everything added after the first public
      version (356 parts, 12 styles). Random picks (planner /
      Auto / Shuffle) use the first version's set unless
      project.extra === true.
   2) Japanese-style (wa): entries built around a traditional Japanese object,
   ...
   Pack authors: packs not listed in J.BASE_PACKS count as Extras;
...
/* may random picks use this entry? (g: a group key, 'style' or 'font') — Extras first, then Japanese-style */
