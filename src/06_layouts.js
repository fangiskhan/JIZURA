...
J.LAYOUTS = {
  ...
  /* ------------------------------------------------ */
  marquee: {
    name: 'Scrolling Bands', fits: n => n <= 12,
  ...
  /* ------------------------------------------------ */
  wave: {
    name: 'Wave Trail', fits: n => n >= 2 && n <= 16,
  ...
  /* ------------------------------------------------ */
  diag: {
    name: 'Diagonal Band', fits: n => n <= 14,
  ...
  /* ------------------------------------------------ */
  stack: {
    name: 'Afterimage Stack', fits: n => n <= 12,
  ...
  /* ------------------------------------------------ special: title card */
  title: {
    name: 'Title', special: true, fits: () => false,
  ...
  /* ------------------------------------------------ special: interlude */
  interlude: {
    name: 'Interlude', special: true, fits: () => false,
