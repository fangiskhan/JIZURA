...
J.EXIT = {
  ...
  explode: {
    name: 'Explode', pieces: true, shatter: true,
    apply(env, it, p, ctx) {
  ...
  fall: {
    name: 'Collapse', pieces: true, shatter: true,
    apply(env, it, p, ctx) {
  ...
  drift: {
    name: 'Mist Away', pieces: true, shatter: true,
    apply(env, it, p, ctx) {
